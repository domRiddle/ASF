...
As you should know already, everybody can change wiki language by adding `-locale` string to any visited page. For example, instead of visiting **[FAQ](FAQ)**, you can visit **[FAQ-ru-RU](FAQ-ru-RU)** that contains FAQ translated into Russian (if available).
