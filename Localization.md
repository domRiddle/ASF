...
- General question - for everything else that doesn't fit any issue below. In general this type should be avoided, as if your problem does not fit any of above, then very likely it's **not** a translation issue.
