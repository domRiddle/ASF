...
If you have trouble understanding the context of the string, e.g. because you're not sure what is the purpose of the message, or when it happens, feel free to leave a comment under specific string, mark it with "Issue", and one of the developers will get back to you with help 👍. **Please avoid using issue mark if you do not need technical/development explanation**.
