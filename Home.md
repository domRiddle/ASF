...
All wiki pages always apply to **[latest ASF release only](https://github.com/JustArchi/ArchiSteamFarm/releases)**. If you'd like to see a wiki page of given fixed point of time (for example for a bit older ASF release), use **[revisions](https://github.com/JustArchi/ArchiSteamFarm/wiki/Home/_history)** that are available on top of every page and pick a date that is appropriate for the date of your ASF release.
