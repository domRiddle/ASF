...
As you can see, we also like preview builds, so very often you might need latest **preview** SDK in order to use generic ASF package. If in doubt, check what our **[continuous integration uses](https://ci.appveyor.com/project/JustArchi/ArchiSteamFarm#L10)** for compiling and deploying ASF releases on GitHub.
