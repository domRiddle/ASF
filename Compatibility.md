...
- `win-x64` works on 64-bit Windows OSes. This includes Windows 7 SP1+, 8.1, 10, 11, Server 2012+ as well as future versions. Windows 7 support is very limited and you may have issues running ASF in that environment, we strongly recommend an update soon.
