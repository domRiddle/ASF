...
- `osx-arm64` works on 64-bit ARM-based (Apple silicon) macOS OSes. It should work on version 11 and newer.
- `osx-x64` works on 64-bit macOS OSes. It should work on version 10.15 and newer.
- `win-arm64` works on 64-bit ARM-based (ARMv8+) Windows OSes. It should work on version 10, 11 and newer.
- `win-x64` works on 64-bit Windows OSes. It should work on version 10, 11, Server 2012+ and newer.
