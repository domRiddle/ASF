...
If you've enabled server GC and kept `BackgroundGCPeriod` disabled, then you have superior ASF performance that should work blazing fast even with hundreds or thousands of enabled bots.