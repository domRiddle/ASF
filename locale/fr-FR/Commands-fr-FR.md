...
| `reprendre [Bots]`                                                   | `PartageFamilial` | Reprend le farm automatique d'instances de bot données. Voir aussi ` pause`, ` play`.                                                                                                                                                                                                                                                                     |
| `démarrer [Bots]`                                                    | `Maître`          | Démarre les instances de bot données.                                                                                                                                                                                                                                                                                                                     |
...
| `arrêter [Bots]`                                                     | `Maître`          | Arrête les instances de bot données.                                                                                                                                                                                                                                                                                                                      |
