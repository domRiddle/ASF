...
| `encrypt <encryptionMethod> <stringToEncrypt>`           | `Propriétaire`    | Encrypts the string using provided cryptographic mechanism - further explained **[below](#encrypt-command)**.                                                                                                                                                                                                                                             |
...
| `hash <hashingMethod> <stringToHash>`                    | `Propriétaire`    | Generated a hash of the string using provided cryptographic mechanism - further explained **[below](#hash-command)**.                                                                                                                                                                                                                                     |
