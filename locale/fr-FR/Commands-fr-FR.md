...
| `bgr <Bots>`                                                         | `Maître`          | Prints information about **[BGR](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Background-games-redeemer)** queue of given bot instances.                                                                                                                                                                                                                 |
...
| `level <Bots>`                                                       | `Maître`          | Shows Steam account level of given bot instances.                                                                                                                                                                                                                                                                                                               |
...
| `redeem <Bots> <Keys>`                                         | `Opérateur`       | Redeems given cd-keys or wallet codes on given bot instances.                                                                                                                                                                                                                                                                                                   |
| `redeem^ <Bots> <Modes> <Keys>`                          | `Opérateur`       | Redeems given cd-keys or wallet codes on given bot instances, using given `modes` explained **[below](#redeem-modes)**.                                                                                                                                                                                                                                         |
