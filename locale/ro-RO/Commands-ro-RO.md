...
Începând cu V4.0.0.9, ASF vine cu o consola interactivă, atâta timp cât nu rulați în modul [**`Headless`**](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Configuration#headless). Apăsați butonul `c` pentru a activa modul de comandă, introduceți comanda și confirmați apăsând tasta enter.
...
| `ieșire`                                                             | `Owner`         | Stops whole ASF process.                                                                                                                                                                                                                                                                                                            |
...
| `întrerupeți [Bots]`                                                 | `Operator`      | Permanently pauses automatic cards farming module of given bot instances. ASF will not attempt to farm current account in this session, unless you manually `resume` it, or restart the process.                                                                                                                                    |
...
| `repornire`                                                          | `Owner`         | Restarts ASF process.                                                                                                                                                                                                                                                                                                               |
| `reluați [Bots]`                                                     | `FamilySharing` | Resumes automatic farming of given bot instances.                                                                                                                                                                                                                                                                                   |
| `începe [Bots]`                                                      | `Master`        | Starts given bot instances.                                                                                                                                                                                                                                                                                                         |
...
| `oprește [Bots]`                                                     | `Master`        | Stops given bot instances.                                                                                                                                                                                                                                                                                                          |
...
| `actualizare`                                                        | `Owner`         | Checks GitHub for ASF updates (this is done automatically every `UpdatePeriod`).                                                                                                                                                                                                                                                    |
| `versiune`                                                           | `FamilySharing` | Prints version of ASF.                                                                                                                                                                                                                                                                                                              |
...
| `nume`  | `n`   | `name/Witcher`   | Part of the game's name, case-insensitive.                                                                                                                                                                                                                              |
