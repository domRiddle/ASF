...
Acest lucru înseamnă că ASF nu are **nicio cerință specifică pentru OS**, pentru că necesită doar să rulați **runtime** pe acel OS și nu necesită modificări de OS directe. As long as that runtime is executing ASF code properly, it does not matter whether underlying OS is Windows, Linux, OS X, BSD, Sony Playstation 4, Nintendo Wii or your toaster - as long as there is **[.NET Core for it](https://github.com/dotnet/core-setup#daily-builds)**, there is **[ASF](https://github.com/JustArchiNET/ArchiSteamFarm/releases/latest)** for it.
