...
| `pozastaviť [Bots]`                                                  | `Operator`      | Permanently pauses automatic cards farming module of given bot instances. ASF will not attempt to farm current account in this session, unless you manually `resume` it, or restart the process.                                                                                                                                    |
...
| `reštartovať`                                                        | `Owner`         | Restarts ASF process.                                                                                                                                                                                                                                                                                                               |
| `obnoviť [Bots]`                                                     | `FamilySharing` | Resumes automatic farming of given bot instances.                                                                                                                                                                                                                                                                                   |
| `spustiť [Bots]`                                                     | `Master`        | Starts given bot instances.                                                                                                                                                                                                                                                                                                         |
...
| `zastaviť [Bots]`                                                    | `Master`        | Stops given bot instances.                                                                                                                                                                                                                                                                                                          |
...
| `aktualizácia`                                                       | `Owner`         | Checks GitHub for ASF updates (this is done automatically every `UpdatePeriod`).                                                                                                                                                                                                                                                    |
