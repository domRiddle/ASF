...
ASF is a C# application that is running on .NET platform. Това означава, че ASF не се компилира директно в **[машинен код](https://en.wikipedia.org/wiki/Machine_code)**, който се изпълнява на вашия процесор, а в **[CIL](https://en.wikipedia.org/wiki/Common_Intermediate_Language)**, който изисква CIL-съвместимо време за изпълнение за изпълнението му.

Този подход има огромно количество предимства, тъй като CIL е независим от платформата, поради което ASF може да работи естествено на много налични операционни системи, особено Windows, Linux и macOS. Не само не е необходима емулация, но и поддръжка за всички оптимизации, свързани с платформата и хардуера, като инструкции за CPU SSE. Благодарение на това ASF може да постигне превъзходна производителност и оптимизация, като същевременно предлага перфектна съвместимост и надеждност.

Това също означава, че ASF няма **няма специфични изисквания за ОС**, тъй като изисква работещо **време за изпълнение** на тази ОС, а не на самата ОС. Докато тази среда за изпълнение изпълнява ASF код правилно, няма значение дали основната операционна система е Windows, Linux, macOS, BSD, Sony Playstation 4, Nintendo Wii или вашият тостер - стига да има **[.NET за него](https://dotnet.microsoft.com/download/dotnet)** има **[ASF](https://github.com/JustArchiNET/ArchiSteamFarm/releases/latest)** за него.
