...
| Стойност | Име               | Описание                                  |
| -------- | ----------------- | ----------------------------------------- |
| 0        | Нищо              | No special online presence flags, default |
