...
![Скрийншот](https://i.imgur.com/bH5Gtjq.png)
...
![Скрийншот](https://i.imgur.com/IvFRJ5S.png)
...
![Скрийншот](https://raw.githubusercontent.com/JustArchiNET/ASF-ui/main/.github/previews/commands.png)
...
| `addlicense [Bots] <Licenses>`                                 | `Оператор`          | Activates given `licenses`, explained **[below](#addlicense-licenses)**, on given bot instances (free games only).                                                                                                                                                                                                                  |
...
| `encrypt <encryptionMethod> <stringToEncrypt>`           | `Собственик`        | Encrypts the string using provided cryptographic method - further explained **[below](#encrypt-command)**.                                                                                                                                                                                                                          |
| `изход`                                                              | `Собственик`        | Stops whole ASF process.                                                                                                                                                                                                                                                                                                            |
...
| `hash <hashingMethod> <stringToHash>`                    | `Собственик`        | Generated a hash of the string using provided cryptographic method - further explained **[below](#hash-command)**.                                                                                                                                                                                                                  |
| `помощ`                                                              | `Семейно Споделяне` | Shows help (link to this page).                                                                                                                                                                                                                                                                                                     |
...
| `продължи [Bots]`                                                    | `Семейно Споделяне` | Resumes automatic farming of given bot instances.                                                                                                                                                                                                                                                                                   |
...
| `update [Channel]`                                                   | `Собственик`        | Checks GitHub for new ASF release and updates to it if available. This is normally done automatically every `UpdatePeriod`. Optional `Channel` argument specifies the `UpdateChannel`, if not provided defaults to the one set in global config.                                                                                    |
...
| Аргумент | Име               | Child of         |
| -------- | ----------------- | ---------------- |
| 1        | Профил            |                  |
| 2        | Притежавани Игри  | Профил           |
| 3        | Играно време      | Притежавани Игри |
| 4        | Списък с Приятели | Профил           |
| 5        | Инвентар          | Профил           |
| 6        | InventoryGifts    | Инвентар         |
| 7        | Коментари         | Профил           |
...
| `име`   | `n`   | `name/Witcher`   | Part of the game's name, case-insensitive.                                                                                                                                                                                                                              |
