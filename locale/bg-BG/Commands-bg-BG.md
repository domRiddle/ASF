...
![Скрийншот](https://raw.githubusercontent.com/JustArchiNET/ASF-ui/master/.github/previews/commands.png)
...
| `encrypt <encryptionMethod> <stringToEncrypt>`           | `Собственик`        | Encrypts the string using provided cryptographic mechanism - further explained **[below](#encrypt-command)**.                                                                                                                                                                                                                       |
| `изход`                                                              | `Собственик`        | Stops whole ASF process.                                                                                                                                                                                                                                                                                                            |
| `farm [Bots]`                                                        | `Master`            | Restarts cards farming module for given bot instances.                                                                                                                                                                                                                                                                              |
| `hash <hashingMethod> <stringToHash>`                    | `Собственик`        | Generated a hash of the string using provided cryptographic mechanism - further explained **[below](#hash-command)**.                                                                                                                                                                                                               |
