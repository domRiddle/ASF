...
| `[Bots] szüneteltetése`                                              | `Operator`      | Permanently pauses automatic cards farming module of given bot instances. ASF will not attempt to farm current account in this session, unless you manually `resume` it, or restart the process.                                                                                                                                    |
...
| `[Bots] folytatása`                                                  | `FamilySharing` | Resumes automatic farming of given bot instances. Also see `pause`, `play`.                                                                                                                                                                                                                                                         |
| `[Bots] indítása`                                                    | `Master`        | Starts given bot instances.                                                                                                                                                                                                                                                                                                         |
...
| `[Bots] leállítása`                                                  | `Master`        | Stops given bot instances.                                                                                                                                                                                                                                                                                                          |
