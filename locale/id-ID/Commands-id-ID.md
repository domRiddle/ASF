...
| `nama`  | `n`   | `name/Witcher`   | Part of the game's name, case-insensitive.                                                                                                                                                                                                                              |
...
| Kata sandi              | `SteamPassword` bot config property, if missing from config.               |
