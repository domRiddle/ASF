...
Il nostro FAQ risponde a domande e risposte comuni che potresti avere. Invece per questioni meno comuni, per favore visita il nosto **[FAQ esteso](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Extended-FAQ)**.
...
- **No, non puoi ottenere carte all'infinito, ogni gioco ha un numero fisso di carte ottenibili. Once you run out of cards to drop in given game (half of a full set), it's not a candidate for farming anymore. It doesn't matter that you own the game, you're done with it.**
