...
| `หยุด [Bots] ชั่วคราว`                                               | `Operator`      | Permanently pauses automatic cards farming module of given bot instances. ASF will not attempt to farm current account in this session, unless you manually `resume` it, or restart the process.                                                                                                                                    |
...
| `เริ่มต้นใหม่`                                                       | `Owner`         | Restarts ASF process.                                                                                                                                                                                                                                                                                                               |
| `ดำเนินการ [Bots] ต่อ`                                               | `FamilySharing` | Resumes automatic farming of given bot instances.                                                                                                                                                                                                                                                                                   |
| `เริ่มการทำงาน [Bots]`                                               | `Master`        | Starts given bot instances.                                                                                                                                                                                                                                                                                                         |
...
| `ชื่อ`  | `n` | `name/Witcher`   | Part of the game's name, case-insensitive.                                                                                                                                                                                                                              |
