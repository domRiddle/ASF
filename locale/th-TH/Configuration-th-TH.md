...
| ค่า | ชื่อ                          | คำอธิบาย                                                                                                 |
| --- | ----------------------------- | -------------------------------------------------------------------------------------------------------- |
| 0   | ไม่มี                         | No special bot behaviour, the least invasive mode, default                                               |
...
| ค่า  | ชื่อ              | คำอธิบาย                                  |
| ---- | ----------------- | ----------------------------------------- |
| 0    | ไม่มี             | No special online presence flags, default |
...
| ค่า | ชื่อ                               | คำอธิบาย                                                                                                                        |
| --- | ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| 0   | ไม่มี                              | No special redeeming preferences, default                                                                                       |
...
| ค่า | ชื่อ          | คำอธิบาย                                                                                                                                                                                                                                                          |
| --- | ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0   | ไม่มี         | No allowed third-party communication, rendering selected ASF features unusable                                                                                                                                                                                    |
...
| ค่า | ชื่อ          | คำอธิบาย                                                                                                                                                                                           |
| --- | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0   | ไม่มี         | No special permission, this is mainly a reference value that is assigned to steam IDs missing in this dictionary - there is no need to define anybody with this permission                         |
...
| ค่า | ชื่อ                | คำอธิบาย                                                                                                                                                                                                              |
| --- | ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0   | ไม่มี               | No special trading preferences, default                                                                                                                                                                               |
