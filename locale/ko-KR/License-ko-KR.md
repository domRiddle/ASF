...
`PackageReference`에 포함된 다양한 **[ASF 콤포넌트](https://github.com/JustArchiNET/ArchiSteamFarm/blob/master/ArchiSteamFarm/ArchiSteamFarm.csproj)** 는 **[LGPL](https://tldrlegal.com/license/gnu-lesser-general-public-license-v3-(lgpl-3))** 같이 다른 조건하에 라이센스되었을 수도 있습니다. 이는 ASF가 활용하는 다른 모든 서드 파티 프로젝트들, 특히 제일 위에 자체 라이센스를 가지고 있는 `도구`에도 동일하게 적용됩니다.
