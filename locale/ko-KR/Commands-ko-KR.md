...
| `balance [Bots]`                                                     | `Master`               | 해당 봇 인스턴스의 지갑 잔고를 보여줍니다.                                                                                                                                                                                                                                                                                                            |
| `bgr [Bots]`                                                         | `Master`               | 해당 봇 인스턴스의 **[백그라운드 게임 등록기](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Background-games-redeemer-ko-KR)** 큐 정보를 표시합니다.                                                                                                                                                                                                     |
| `bl [Bots]`                                                          | `Master`               | 해당 봇 인스턴스들의 거래 모듈에서 블랙리스트에 등록된 유저 목록을 보여줍니다.                                                                                                                                                                                                                                                                                        |
| `bladd [Bots] <SteamIDs64>`                                    | `Master`               | 해당 봇 인스턴스들의 거래 모듈에서 해당 `steamIDs`를 블랙리스트에 등록합니다.                                                                                                                                                                                                                                                                                    |
| `blrm [Bots] <SteamIDs64>`                                     | `Master`               | 헤당 봇 인스턴스들의 거래 모듈에서 주어진 `steamIDs`를 블랙리스트에서 제거합니다.                                                                                                                                                                                                                                                                                  |
| `encrypt <encryptionMethod> <stringToEncrypt>`           | `소유자`                  | Encrypts the string using provided cryptographic method - further explained **[below](#encrypt-command)**.                                                                                                                                                                                                                          |
| `exit`                                                               | `소유자`                  | 모든 ASF 프로세스를 중지합니다.                                                                                                                                                                                                                                                                                                                 |
| `farm [Bots]`                                                        | `Master`               | 해당 봇 인스턴스들의 카드 농사 모듈을 재시작합니다.                                                                                                                                                                                                                                                                                                       |
| `hash <hashingMethod> <stringToHash>`                    | `소유자`                  | Generated a hash of the string using provided cryptographic method - further explained **[below](#hash-command)**.                                                                                                                                                                                                                  |
| `help`                                                               | `가족 공유(FamilySharing)` | 도움말을 보여줍니다 (이 페이지로 연결).                                                                                                                                                                                                                                                                                                             |
| `input [Bots] <Type> <Value>`                            | `Master`               | 해당 봇 인스턴스들의 지정된 입력 형식을 주어진 값으로 설정하며, `Headless` 모드에서만 동작합니다 - 추가 설명은 **[아래](#input-command)**.                                                                                                                                                                                                                                      |
| `ib [Bots]`                                                          | `Master`               | 봇 인스턴스들의 자동 농사에서 블랙리스트에 등록된 게임 목록을 보여줍니다.                                                                                                                                                                                                                                                                                           |
| `ibadd [Bots] <AppIDs>`                                        | `Master`               | 봇 인스턴스들의 자동 농사에서 `appIDs` 를 게임 블랙리스트에 등록합니다.                                                                                                                                                                                                                                                                                        |
| `ibrm [Bots] <AppIDs>`                                         | `Master`               | 봇 인스턴스들의 자동 농사에서 `appIDs` 를 게임 블랙리스트에서 제거합니다.                                                                                                                                                                                                                                                                                       |
| `iq [Bots]`                                                          | `Master`               | 봇 인스턴스들의 우선 농사 대기열을 보여줍니다.                                                                                                                                                                                                                                                                                                          |
| `iqadd [Bots] <AppIDs>`                                        | `Master`               | 봇 인스턴스들의 우선 농사 대기열에 `appIDs`를 등록합니다.                                                                                                                                                                                                                                                                                                |
| `iqrm [Bots] <AppIDs>`                                         | `Master`               | 봇 인스턴스들의 우선 농사 대기열에서 `appIDs`를 제거합니다.                                                                                                                                                                                                                                                                                               |
| `level [Bots]`                                                       | `Master`               | 봇 인스턴스들의 스팀 계정 레벨을 보여줍니다.                                                                                                                                                                                                                                                                                                           |
| `loot [Bots]`                                                        | `Master`               | 해당 봇 인스턴스들의 모든 `LootableTypes`의 스팀 커뮤니티 아이템들을 `SteamUserPermissions`에서 사용자 설정한 `Master` (하나보다 많은 경우에는 가장 낮은 steamID) 에게 모두 전달합니다.                                                                                                                                                                                                   |
...
| `loot^ [Bots] <AppID> <ContextID>`                       | `Master`               | 해당 봇 인스턴스들의 지정된 `ContextID` 에 있는 주어진 `AppID`의 스팀 아이템들을 `SteamUserPermissions`에서 사용자 설정한 `Master` (하나보다 많은 경우에는 가장 낮은 steamID) 에게 모두 전달합니다.                                                                                                                                                                                          |
...
| `nickname [Bots] <Nickname>`                                   | `Master`               | 해당 봇 인스턴스들의 스팀 닉네임을 주어진 `nickname`으로 변경합니다.                                                                                                                                                                                                                                                                                         |
| `owns [Bots] <Games>`                                          | `Operator`             | Checks if given bot instances already own given `games`, explained **[below](#owns-games)**.                                                                                                                                                                                                                                        |
| `password [Bots]`                                                    | `Master`               | 해당 봇 인스턴스들의 암호화된 비밀번호를 출력합니다 (`PasswordFormat`과 함께 쓰고 있음).                                                                                                                                                                                                                                                                          |
| `pause [Bots]`                                                       | `Operator`             | 해당 봇 인스턴스들의 자동 카드 농사 모듈을 영구적으로 정지합니다. 수동으로 `resume` 하거나 프로세스를 재시작하기 전까지 ASF는 이 세션에서 해당 계정의 농사를 시도하지 않을 것입니다.                                                                                                                                                                                                                        |
| `pause~ [Bots]`                                                      | `FamilySharing`        | 해당 봇 인스턴스들의 자동 카드 농사 모듈을 일시 정지합니다. 농사는 다음 실행 이벤트 또는 봇 연결 해제시에 자동으로 재개됩니다. 일시 정지를 해제하기 위해서 `resume` 할 수 있습니다.                                                                                                                                                                                                                        |
| `pause& [Bots] <Seconds>`                                  | `Operator`             | 당 봇 인스턴스들의 자동 카드 농사 모듈을 주어진 `seconds`의 기간 동안 일시 정지합니다. 지연 시간이 지나고, 카드 농사 모듈이 자동으로 재개됩니다.                                                                                                                                                                                                                                            |
...
| `restart`                                                            | `Owner`                | ASF 프로세스를 재시작합니다.                                                                                                                                                                                                                                                                                                                   |
| `resume [Bots]`                                                      | `FamilySharing`        | 해당 봇 인스턴스들의 자동 농사를 재개합니다. 또한 `pause`, `play`을 보세요.                                                                                                                                                                                                                                                                                  |
| `start [Bots]`                                                       | `Master`               | 해당 봇 인스턴스들을 시작합니다.                                                                                                                                                                                                                                                                                                                  |
| `stats`                                                              | `Owner`                | 관리되는 메모리 사용량과 같은 프로세스 통계를 출력합니다.                                                                                                                                                                                                                                                                                                    |
| `status [Bots]`                                                      | `FamilySharing`        | 해당 봇 인스턴스들의 상태를 출력합니다.                                                                                                                                                                                                                                                                                                              |
| `stop [Bots]`                                                        | `Master`               | 해당 봇 인스턴스들을 중지합니다.                                                                                                                                                                                                                                                                                                                  |
...
| `unpack [Bots]`                                                      | `Master`               | 해당 봇 인스턴스들의 보관함에 있는 모든 부스터팩을 뜯습니다.                                                                                                                                                                                                                                                                                                  |
| `update`                                                             | `Owner`                | ASF의 업데이트를 위해서 GitHub를 확인합니다 (이것은 매 `UpdatePeriod` 마다 자동으로 실행됨).                                                                                                                                                                                                                                                                    |
| `version`                                                            | `FamilySharing`        | ASF의 버전을 출력합니다.                                                                                                                                                                                                                                                                                                                     |
