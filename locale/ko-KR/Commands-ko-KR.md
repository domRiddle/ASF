...
| `encrypt <encryptionMethod> <stringToEncrypt>`           | `소유자(Owner)`           | Encrypts the string using provided cryptographic mechanism - further explained **[below](#encrypt-command)**.                                                                                                                                                                                                                       |
| `exit`                                                               | `소유자(Owner)`           | 모든 ASF 프로세스를 중지합니다.                                                                                                                                                                                                                                                                                                                 |
| `farm [Bots]`                                                        | `주인(Master)`           | 해당 봇 인스턴스들의 카드 농사 모듈을 재시작합니다.                                                                                                                                                                                                                                                                                                       |
| `hash <hashingMethod> <stringToHash>`                    | `소유자(Owner)`           | Generated a hash of the string using provided cryptographic mechanism - further explained **[below](#hash-command)**.                                                                                                                                                                                                               |
