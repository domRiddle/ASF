...
Every language has its own rules in regards to pluralization. Šitos taisyklės gali būti rastos **[CLDR](https://unicode-org.github.io/cldr-staging/charts/latest/supplemental/language_plural_rules.html)**, kuris nurodo jų numerius ir tikslias kalbos kondicijas.
...
Be extremely careful when you translate sentences with `<code></code>` blocks inside. Code block indicates fixed ASF code names or terms that should not be translated. Pavyzdys:
