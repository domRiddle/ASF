...
| `pristabdyti [Bots]`                                                 | `Operator`      | Permanently pauses automatic cards farming module of given bot instances. ASF will not attempt to farm current account in this session, unless you manually `resume` it, or restart the process.                                                                                                                                    |
...
| `tęsti [Bots]`                                                       | `FamilySharing` | Resumes automatic farming of given bot instances. Also see `pause`, `play`.                                                                                                                                                                                                                                                         |
| `paleisti [Bots]`                                                    | `Master`        | Starts given bot instances.                                                                                                                                                                                                                                                                                                         |
...
| `sustabdyti [Bots]`                                                  | `Master`        | Stops given bot instances.                                                                                                                                                                                                                                                                                                          |
