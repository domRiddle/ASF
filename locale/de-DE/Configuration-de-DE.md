...
Die `log.txt` Datei enthält das Protokoll, das durch Ihre letzte ASF-Ausführung erzeugt wurde. Diese Datei enthält keine sensiblen Informationen und ist äußerst nützlich, wenn es um Probleme, Abstürze oder einfach nur als Information an Sie geht, was während der letzten Ausführung von ASF passiert ist. Wir werden sehr oft nach dieser Datei fragen, wenn Sie auf Probleme oder Fehler stoßen. ASF verwaltet diese Datei automatisch für Sie, aber Sie können die ASF **[Protokollierungsmodul](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Logging-de-DE#Protokollierung)** weiter optimieren, wenn Sie ein fortgeschrittener Benutzer sind.
