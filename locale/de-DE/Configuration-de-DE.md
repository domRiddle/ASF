...
`ImmutableList<byte>` Typ mit einem leeren Standardwert. This property defines the **preferred** farming order used by ASF for given bot account. Derzeit sind folgende Sammel-Reihenfolgen verfügbar:
