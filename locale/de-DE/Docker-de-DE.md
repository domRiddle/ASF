...
Ein ASF-Docker-Image steht derzeit für zwei Architekturen zur Verfügung - `X64` und `Arm`. You can read more about them in **[compatibility](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Compatibility)** section.
