...
| `play <Bots> <AppIDs,GameName>`                                | `Master`        | Wechselt zum manuellem Sammeln - startet die angegebenen `AppIDs` auf den angegebenen Bot-Instanzen, optional auch mit benutzerdefiniertem `GameName`. Use `reset` or `resume` for returning.                                                                                  |
