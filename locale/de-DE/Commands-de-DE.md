...
| `pausiere [Bots]`                                                    | `Operator`      | Pausiert permanent das automatische Karten-Sammel-Modul der gegebenen Bot-Instanzen. ASF wird nicht versuchen, das aktuelle Konto in dieser Sitzung zu verwalten, es sei denn, du setzt `resume` manuell ein oder startest den Prozess neu.                                                                                                                              |
...
| `fortsetzen [Bots]`                                                  | `FamilySharing` | Setzt das automatische Sammeln der gegebenen Bot-Instanzen fort. Siehe auch `pause`, `play`.                                                                                                                                                                                                                                                                             |
| `starte [Bots]`                                                      | `Master`        | Startet gegebene Bot-Instanzen.                                                                                                                                                                                                                                                                                                                                          |
