...
Sie können den Befehl zum angegebenen ASF-Bot auch über den Steam-Chat ausführen. Natürlich können Sie nicht direkt mit sich selbst schreiben, deshalb brauchen Sie mindestens ein weiteres Bot-Konto, wenn Sie Befehle ausführen willst, die auf das Haupt-Konto abzielen.
...
| `mabadd [Bots] <AppIDs>`                                       | `Master`        | Fügt gegebene `appIDs` zur App-Blacklist hinzu, die vom automatischen Handeln durch **[`MatchActively`](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Trading-de-De#matchactively)** gesperrt sind.                                                                                                                                                              |
...
| `pause [Bots]`                                                       | `Operator`      | Pausiert permanent das automatische Karten-Sammel-Modul der gegebenen Bot-Instanzen. ASF wird nicht versuchen, das aktuelle Konto in dieser Sitzung zu verwalten, es sei denn, Sie verwenden `resume` manuell ein oder starten den Prozess neu.                                                                                                                        |
...
| `stats`                                                              | `Besitzer`      | Gibt Prozessstatistiken an, wie z.B. die Nutzung des verwalteten Speichers.                                                                                                                                                                                                                                                                                            |
