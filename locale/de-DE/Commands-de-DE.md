...
| `pause <Bots>`                                                       | `Operator`      | Pausiert permanent das automatische Karten-Sammel-Modul der gegebenen Bot-Instanzen. ASF wird in der aktuellen Sitzung nicht versuchen auf den angegebenen Bots zu Sammeln, es sei denn du verwendest selbst `resume` oder startest den Prozess neu.                           |
