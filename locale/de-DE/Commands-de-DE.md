...
| `bladd [Bots] <SteamIDs64>`                                    | `Master`        | Setzt gegebene `steamIDs` auf die Schwarze Liste des Handelsmoduls der gegebenen Bot-Instanzen.                                                                                                                                                                                                                                                                        |
...
| `iqadd [Bots] <AppIDs>`                                        | `Master`        | Fügt gegebene `appIDs` zur priorisierten Sammel-Warteschlange der gegebenen Bot-Instanzen hinzu.                                                                                                                                                                                                                                                                       |
| `iqrm [Bots] <AppIDs>`                                         | `Master`        | Entfernt gegebene `appIDs` aus der priorisierten Sammel-Warteschlange der gegebenen Bot-Instanzen.                                                                                                                                                                                                                                                                     |
...
| `owns [Bots] <Games>`                                          | `Operator`      | Prüft, ob die Bot-Instanzen bereits im Besitz von `games`, wie **[unten](#owns-spiele)** erklärt.                                                                                                                                                                                                                                                                      |
...
| `transfer^ [Bots] <AppID> <ContextID> <TargetBot>` | `Master`        | Sendet alle Steam-Gegenstände von bestimmter/n `AppID` in `ContextID` der gegebenen Bot-Instanzen an die Ziel-Bot-Instanz.                                                                                                                                                                                                                                             |
