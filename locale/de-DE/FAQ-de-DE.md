...
Wenn das Karten-Sammel-Modul angehalten/deaktiviert ist, können Sie zusätzliche ASF-Funktionen nutzen, z. B. `GamesPlayedWhileIdle`.
...
Eine offensichtliche Lösung ist das Datum auf Ihrer Maschine entsprechend einzustellen. Es wird dringend empfohlen, eine automatische Datumssynchronisation zu verwenden, z. B. die unter Windows verfügbare native Synchronisation oder `ntpd` unter Linux.
