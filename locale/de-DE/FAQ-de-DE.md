...
Du kannst so viele ASF-Instanzen auf einem Computer ausführen, wie du willst, vorausgesetzt, jede Instanz hat ihr eigenes Verzeichnis und ihre eigenen Konfigurationen, und das in einer Instanz verwendete Konto wird in einer anderen nicht verwendet. Allerdings solltest du dich fragen, warum du das tun willst. ASF ist dazu optimiert, einige dutzend Anfragen gleichzeitig zu verarbeiten, während mehrere Bots in separate ASF-Instanzen ausgeführt werden. Das führt allerdings auch dazu, dass die Leistung der einzelnen Instanzen sinkt, da mehr Betriebssystem-Ressourcen (beispielsweise CPU und Arbeitsspeicher) verbraucht werden und birgt die Gefahr von Synchonitäts-Problemen zwischen den verschiedenen ASF-Instanzen, da ASF seine Begrenzung mit den anderen Instanzen teilen muss.
