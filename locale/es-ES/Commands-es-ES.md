...
| `tbadd [Bots] <SteamIDs64>`                                    | `Master`        | Bloquea determinadas `steamIDs` del módulo de intercambio de las instancias de bot especificadas.                                                                                                                                                                                                                                                                                                            |
| `tbrm [Bots] <SteamIDs64>`                                     | `Master`        | Desbloquea determinadas `steamIDs` del módulo de intercambio de las instancias de bot especificadas.                                                                                                                                                                                                                                                                                                         |
