...
| `encrypt <encryptionMethod> <stringToEncrypt>`           | `Propietario`      | Encrypts the string using provided cryptographic method - further explained **[below](#encrypt-command)**.                                                                                                                                                                                                                                                                                    |
...
| `hash <hashingMethod> <stringToHash>`                    | `Propietario`      | Generated a hash of the string using provided cryptographic method - further explained **[below](#hash-command)**.                                                                                                                                                                                                                                                                            |
