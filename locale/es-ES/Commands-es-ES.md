...
| `encrypt <encryptionMethod> <stringToEncrypt>`           | `Propietario`      | Cifra la cadena de caracteres usando el mecanismo criptográfico proporcionado - se explica con detalle **[debajo](#comando-encrypt)**.                                                                                                                                                                                                                                                        |
...
| `hash <hashingMethod> <stringToHash>`                    | `Propietario`      | Genera un hash de la cadena de caracteres usando el mecanismo criptográfico proporcionado - explicado con detalle **[debajo](#comando-hash)**.                                                                                                                                                                                                                                                |
