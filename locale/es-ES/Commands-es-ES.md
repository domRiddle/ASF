...
| `2fafinalize [Bots] <ActivationCode>`                          | `Master`        | Finaliza el proceso de asignar nuevas credenciales **[2FA](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication-es-ES#creación)** a las instancias de bot especificadas.                                                                                                                                                                                                            |
| `2fafinalized [Bots] <ActivationCode>`                         | `Master`        | Importa credenciales **[2FA](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication-es-ES#creación)** ya finalizadas para las instancias de bot especificadas, usando el código para verificación.                                                                                                                                                                                    |
| `2fafinalizedforce [Bots]`                                           | `Master`        | Importa credenciales **[2FA](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication-es-ES#creación)** ya finalizadas para las instancias de bot especificadas, omitiendo el código de verificación.                                                                                                                                                                                   |
