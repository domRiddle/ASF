...
| `hash <hashingMethod> <stringToHash>`                    | `Propietario`      | Generated a hash of the string using provided cryptographic mechanism - further explained **[below](#hash-command)**.                                                                                                                                                                                                                                                                         |
