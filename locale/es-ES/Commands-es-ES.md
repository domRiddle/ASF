...
| `encrypt <cryptoMethod> <stringToEncrypt>`               | `Propietario`      | Cifra la cadena de caracteres usando el mecanismo criptográfico proporcionado - se explica con detalle **[debajo](#comando-encrypt)**.                                                                                                                                                                                                                                                        |
...
El comando encrypt permite cifrar cadenas de caracteres arbitrarias usando los mecanismos de cifrado de ASF. `<cryptoMethod>` debe ser uno de los siguientes:
