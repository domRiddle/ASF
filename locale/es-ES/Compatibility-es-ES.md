...
- `win-x64` funciona con sistemas operativos Windows de 64 bits. Esto incluye Windows 7 SP1+, 8.1, 10, 11, Server 2012+ así como futuras versiones. Windows 7 requiere **[correcciones adicionales](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Setting-up-es-ES#windows)** y su soporte es muy limitado, podrías tener problemas al ejecutar ASF en ese entorno. Recomendamos una actualización pronto, ya que es probable que futuras versiones de ASF dejen de funcionar por completo es dicho entorno, por no mencionar que el sistema operativo llegó al final de su vida en el 2020.
