...
Para usar esa opción, tienes que cumplir ciertos requisitos. Como mínimo debes tener una cuenta **[no limitada](https://https://help.steampowered.com/es/faqs/view/71D3-35C2-AD96-AA3A)**, **[ASF 2FA](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication-es-ES#asf-2fa)** activo y por lo menos un tipo de artículo válido en `MatchableTypes`, tal como los cromos. Requisitos adicionales incluyen 2FA activo por lo menos 15 días, último cambio de contraseña superior a 5 días, no tener limitaciones de cuenta como bloqueos, baneos del mercado y de intercambio.
