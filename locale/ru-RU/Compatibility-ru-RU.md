...
Мы рекомендуем отказаться от OpenVZ в пользу гораздо лучших решений для виртуализации, таких как KVM. Проблема, описанная здесь, это действительно ошибка в среде исполнения .NET Core, которую рано или поздно исправят, но нет чётких сроков, когда это произойдёт. Если у вас нет возможности перейти на лучшее решение для виртуализации - вы можете подумать о использовании ASF в варианте `generic-netf` с помощью `mono`.