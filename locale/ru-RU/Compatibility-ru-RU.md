...
Этот подход имеет огромное количество преимуществ, так как CIL не зависит от платформы, поэтому ASF может работать на многих доступных ОС, особенно на Windows, Linux и macOS. Нет необходимости не только в эмуляции, но и в поддержке всех оптимизаций, связанных с платформой и оборудованием, таких как CPU SSE инструкции. Благодаря этому, ASF может достигать превосходной производительности и оптимальности, и при этом оставаться прекрасно совместимым и надёжным.
