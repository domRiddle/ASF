...
Активирует указанные ключи или коды пополнения на заданных ботах, с использованием режимов `modes`, подробно описанных **[ниже](#user-content-значения-redeem).</td> </tr> 
