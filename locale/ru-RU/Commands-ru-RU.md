...
Starting with V4.0.0.9, ASF has support for interactive console, as long as you're not running ASF in [**`Headless`**](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Configuration#headless) mode. Просто нажмите кнопку `c` (англ.) для включения режима команд, введите свою команду и подтвердите с помощью enter.
