...
| `ib [Боты]`                                                          | `Master`        | Перечисляет приложения, попавшие в черный список из автоматической торговли в **[`MatchActively`](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Trading-ru-RU#matchactively)**.                                                                                                                                                |
...
| `mabrm [Bots] <AppIDs>`                                        | `Master`        | Удаляет указанные `appID` из черного списка автоматической торговли в **[`MatchActively`](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Trading-ru-RU#matchactively)**.                                                                                                                                                        |
