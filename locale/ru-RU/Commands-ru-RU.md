...
| `encrypt <cryptoMethod> <stringToEncrypt>`               | `Owner`         | Шифрует указанную строку используя заданный криптографический механизм - подробное описание смотри **[ниже](#user-content-Команда-encrypt)**.                                                                                                                                                                                        |
...
Команда encrypt позволяет зашифровать произвольную строку используя механизмы шифрования ASF. Параметр `<cryptoMethod>` может иметь одно из следующих значений:
