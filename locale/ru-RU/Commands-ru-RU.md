...
| `возобновить работу [Bots]`                                          | `FamilySharing` | Возобновляет автоматический фарм на заданных ботах. См. также `pause`, `play`.                                                                                                                                                                                                                                                       |
| `запустить [Bots]`                                                   | `Master`        | Запускает заданных ботов.                                                                                                                                                                                                                                                                                                            |
...
| `остановить [Bots]`                                                  | `Master`        | Останавливает заданных ботов.                                                                                                                                                                                                                                                                                                        |
