...
#### **[Windows](https://docs.microsoft.com/ru-ru/dotnet/core/install/dependencies?tabs=netcore30&pivots=os-windows)**:
...
#### **[Linux](https://docs.microsoft.com/ru-ru/dotnet/core/install/dependencies?tabs=netcore30&pivots=os-linux)**:
...
#### **[OS X](https://docs.microsoft.com/ru-ru/dotnet/core/install/dependencies?tabs=netcore30&pivots=os-macos)**:
...
- Установить **[предусловия для .NET Core](https://docs.microsoft.com/dotnet/core/install/dependencies?tabs=netcore30)**.
