...
Теперь вернитесь к сетевому генератору конфигураций и введите его в поле SteamOwnerID. Lastly, you need to enable `IPC` option nearby for the interface to activate.
