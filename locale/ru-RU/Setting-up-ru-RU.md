...
После скачивания, начните с того чтобы распаковать zip-файл в отдельную папку. Мы рекомендуем использовать **[[7-zip](https://7-zip.org/)](https://www.7-zip.org)**, но все стандартные утилиты типа `unzip` в Linux/OS X тоже должны работать без проблем.
...
Сейчас самое время ознакомиться с разделом **[[Remote Communication](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Remote-communication-ru-ru)](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Remote-communication)**, если вас беспокоят вещи, на которые ASF запрограммирован, например, присоединение к определенной группе Steam при запуске.
