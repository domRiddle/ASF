...
- На данный момент никаких дополнительных требований нет, но у вас должна быть установлена последняя версия OS X, как минимум 10.14+
...
Теперь вы готовы к первому запуску программы. Просто дважды кликните на запускаемом файле `ArchiSteamFarm` в папке ASF. You can also start it from the console.
