...
Для выполнения шагов, описанных ниже, вам нужно иметь уже привязанный и работоспособный аутентификатор, поддерживаемый ASF. ASF на данный момент поддерживает несколько разных официальных и неофициальных источников 2ФА - Android, iOS, SteamDesktopAuthenticator и WinAuth. Если у вас ещё нет аутентификатора, вам нужно для начала выбрать один из перечисленных выше и установить его. Если у вас нет предпочтений, какой из них использовать, мы рекомендуем WinAuth, но работать будет любой из них, если конечно вы будете следовать инструкциям.
