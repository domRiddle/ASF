...
ASF allows you to pass **[command-line arguments](Command-line-arguments)** in docker container by using `ASF_ARGS` environment variable. This can be added on top of `docker run` with `-e` switch. Например:
