...
Ваш проект должен быть стандартной библиотекой .NET, ориентированной на соответствующую платформу вашей целевой версии ASF, как указано в ** [компиляция](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Compilation-ru-RU)**. We recommend you to target .NET (Core), but .NET Framework plugins are also available.
