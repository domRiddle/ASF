...
**Да**, нам известно как минимум о нескольких случаях в которых пользователи получили те или иные блокировки в Steam. Whether ASF itself was the root cause or not is entirely different story that we'll probably never get to know.
