...
В нормальных условиях, любой сбой или вылет ASF создаст запись в файле `log.txt` в папке программы и просмотреть, который может быть использован для установления причин этого.
