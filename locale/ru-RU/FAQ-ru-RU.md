...
- **Нет, вы не можете фармить игру бесконечно, из каждой игры выпадает фиксированное количество карточек. Когда карточки в игре закончились, фармить её нет смысла. Неважно, что вы владеете игрой, вы с ней закончили.**
...
Вы не получите никакой выгоды от запуска более 1 копии на IP/интерфейс. Steam не позволит вам волшебным образом запустить больше ботов только потому что вы их запускаете в другой копии ASF, и если уж на то пошло - ASF вас никак не ограничивает.
