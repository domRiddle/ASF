...
> Редактирование включает в себя замену персональных данных, например на звездочки. You should refrain from removing sensitive lines entirely, as their pure existence might be relevant and should be preserved.
...
В данный момент этот параметр по умолчанию не включает в себя протокол UDP из-за проблемы **[#882](https://github.com/JustArchi/ArchiSteamFarm/issues/882)**.
