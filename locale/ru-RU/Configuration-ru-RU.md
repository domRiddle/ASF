...
Чтобы использовать ASF-ui, у вас должен быть включен интерфейс **[IPC](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/IPC)**. `IPC` is enabled by default, therefore you can access it right away, as long as you didn't disable it yourself.
