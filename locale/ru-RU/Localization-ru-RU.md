...
- Mistake in the source string - Ошибка в исходной строке. Этот тип должен использоваться только если вы полагаете что исходная (английская) строка неверна. Это довольно редкий случай, но поскольку английский не родной для разработчиков, не стесняйтесь пользоваться этим типом сообщений есть у вас идеи по улучшению. В качестве альтернативы, поскольку это непосредственно связано с разработкой, вы можете использовать для этой цели наши **[выпуски GitHub](https://github.com/JustArchiNET/ArchiSteamFarm/issues/new/choose)**, если хотите.
