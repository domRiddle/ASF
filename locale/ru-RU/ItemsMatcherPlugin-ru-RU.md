...
Ваши данные хранятся максимум в течение недели с момента, как вы перестаете использовать (объявляться) на нашем листинге, и автоматически удаляются по истечении этого периода.
