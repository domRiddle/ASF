...
| `thoát`                                                              | `Chủ sở hữu`       | Stops whole ASF process.                                                                                                                                                                                                                                                                                                            |
...
| `loot^ [Bots] <AppID> <ContextID>`                       | `Tối cao`          | Sends all Steam items from given `AppID` in `ContextID` of given bot instances to `Master` user defined in their `SteamUserPermissions` (with lowest steamID if more than one).                                                                                                                                                     |
...
| `tạm dừng [Bots]`                                                    | `Quản lý`          | Permanently pauses automatic cards farming module of given bot instances. ASF will not attempt to farm current account in this session, unless you manually `resume` it, or restart the process.                                                                                                                                    |
...
| `tiếp tục [Bots]`                                                    | `Chia sẻ gia đình` | Resumes automatic farming of given bot instances. Also see `pause`, `play`.                                                                                                                                                                                                                                                         |
| `khởi động [Bots]`                                                   | `Tối cao`          | Starts given bot instances.                                                                                                                                                                                                                                                                                                         |
...
| `dừng [Bots]`                                                        | `Tối cao`          | Stops given bot instances.                                                                                                                                                                                                                                                                                                          |
