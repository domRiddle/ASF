...
ASF hỗ trợ nhiều loại lệnh khác nhau, được sử dụng để kiểm soát hoạt động của các quá trình và trạng thái bot.
...
Bảng điều khiển không có sẵn cho chế độ [**`Headless`**](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Configuration#headless).
...
| `balance [Bots]`                                                     | `Master`        | Hiển thị số dư ví của các bot đã cấp.                                                                                                                                                                                                                                                                                               |
| `bgr [Bots]`                                                         | `Master`        | In thông tin về hàng đợi **[BGR](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Background-games-redeemer)** của các bot đã cấp.                                                                                                                                                                                               |
...
| `blrm [Bots] <SteamIDs64>`                                     | `Master`        | Xóa danh sách đen `steamIDs` được cung cấp từ mô-đun giao dịch của các phiên bản bot đã cấp.                                                                                                                                                                                                                                        |
| `encrypt <encryptionMethod> <stringToEncrypt>`           | `Owner`         | Mã hóa chuỗi bằng phương thức mã hóa được cung cấp - được giải thích thêm **[dưới đây](#encrypt-command)**.                                                                                                                                                                                                                         |
| `exit`                                                               | `Owner`         | Dừng toàn bộ quá trình ASF.                                                                                                                                                                                                                                                                                                         |
| `farm [Bots]`                                                        | `Master`        | Khởi động lại mô-đun cày thẻ cho các bot đã cấp.                                                                                                                                                                                                                                                                                    |
| `hash <hashingMethod> <stringToHash>`                    | `Owner`         | Tạo hàm băm của chuỗi bằng phương thức mã hóa được cung cấp - được giải thích thêm **[dưới đây](#hash-command)**.                                                                                                                                                                                                                   |
| `help`                                                               | `FamilySharing` | Hiển thị trợ giúp (đường dẫn tới trang này).                                                                                                                                                                                                                                                                                        |
| `input [Bots] <Type> <Value>`                            | `Master`        | Đặt loại đầu vào đã cho để đưa ra giá trị cho các bot đã cấp, chỉ hoạt động ở chế độ `Headless` - được giải thích thêm **[dưới đây](#input-command)**.                                                                                                                                                                              |
| `ib [Bots]`                                                          | `Master`        | Liệt kê các ứng dụng trong danh sách đen từ việc chạy không tự động của các bot đã cấp.                                                                                                                                                                                                                                             |
| `ibadd [Bots] <AppIDs>`                                        | `Master`        | Thêm `appIDs` đã cấp tới các ứng dụng trong danh sách đen từ việc chạy không tự động của các bot đã cấp.                                                                                                                                                                                                                            |
| `ibrm [Bots] <AppIDs>`                                         | `Master`        | Xóa `appIDs` đã cấp khỏi các ứng dụng trong danh sách đen từ việc chạy không tự động của các bot đã cấp.                                                                                                                                                                                                                            |
