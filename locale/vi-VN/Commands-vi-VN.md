...
| `tb [Bots]`                                                          | `Master`        | Liệt kê danh sách người dùng trong danh sách đen từ mô-đun giao dịch của các phiên bản bot đã cấp.                                                                                                                                                                                                                                  |
| `tbadd [Bots] <SteamIDs64>`                                    | `Master`        | Danh sách đen `steamIDs` được cung cấp từ mô-đun giao dịch của các phiên bản bot đã cấp.                                                                                                                                                                                                                                            |
| `tbrm [Bots] <SteamIDs64>`                                     | `Master`        | Xóa danh sách đen `steamIDs` được cung cấp từ mô-đun giao dịch của các phiên bản bot đã cấp.                                                                                                                                                                                                                                        |
