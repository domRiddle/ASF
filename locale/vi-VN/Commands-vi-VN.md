...
Bắt đầu từ phiển bản V4.0.0.9, ASF hỗ trợ giao diện bản điều khiển tương tác, có thể được bật bằng thuộc tính [**`SteamOwnerID`**](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Configuration#steamownerid). Afterwards, simply press `c` button in order to enable command mode, type your command and confirm with enter.
...
| `thoát`                                                                    | `Owner`         | Stops whole ASF process.                                                                                                                                                                                                                                                                                                            |
...
| `khởi động lại`                                                            | `Owner`         | Restarts ASF process.                                                                                                                                                                                                                                                                                                               |
...
| `cập nhật`                                                                 | `Owner`         | Checks GitHub for ASF updates (this is done automatically every `UpdatePeriod`).                                                                                                                                                                                                                                                    |
| `phiên bản`                                                                | `FamilySharing` | Prints version of ASF.                                                                                                                                                                                                                                                                                                              |
