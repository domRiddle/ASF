...
| `დააპაუზე [Bots]`                                                    | `Operator`      | Permanently pauses automatic cards farming module of given bot instances. ASF will not attempt to farm current account in this session, unless you manually `resume` it, or restart the process.                                                                                                                                    |
...
| `რესტარტი`                                                           | `Owner`         | Restarts ASF process.                                                                                                                                                                                                                                                                                                               |
| `გააგრძელე [Bots]`                                                   | `FamilySharing` | Resumes automatic farming of given bot instances. Also see `pause`, `play`.                                                                                                                                                                                                                                                         |
| `ჩართე [Bots]`                                                       | `Master`        | Starts given bot instances.                                                                                                                                                                                                                                                                                                         |
...
| `გამორთე [Bots]`                                                     | `Master`        | Stops given bot instances.                                                                                                                                                                                                                                                                                                          |
...
| `განახლება`                                                          | `Owner`         | Checks GitHub for ASF updates (this is done automatically every `UpdatePeriod`).                                                                                                                                                                                                                                                    |
...
| პაროლი                  | `SteamPassword` bot config property, if missing from config.               |
