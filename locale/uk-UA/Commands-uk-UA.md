...
| `вихід`                                                              | `Owner`         | Stops whole ASF process.                                                                                                                                                                                                                                                                                                            |
...
| `призупинити [Bots]`                                                 | `Operator`      | Permanently pauses automatic cards farming module of given bot instances. ASF will not attempt to farm current account in this session, unless you manually `resume` it, or restart the process.                                                                                                                                    |
...
| `перезапуск`                                                         | `Owner`         | Restarts ASF process.                                                                                                                                                                                                                                                                                                               |
| `відновити роботу [Bots]`                                            | `FamilySharing` | Resumes automatic farming of given bot instances. Also see `pause`, `play`.                                                                                                                                                                                                                                                         |
| `запустити [Bots]`                                                   | `Master`        | Starts given bot instances.                                                                                                                                                                                                                                                                                                         |
...
| `зупинити [Bots]`                                                    | `Master`        | Stops given bot instances.                                                                                                                                                                                                                                                                                                          |
...
| `оновити`                                                            | `Owner`         | Checks GitHub for ASF updates (this is done automatically every `UpdatePeriod`).                                                                                                                                                                                                                                                    |
| `версія`                                                             | `FamilySharing` | Prints version of ASF.                                                                                                                                                                                                                                                                                                              |
...
| `ім'я`  | `n`   | `name/Witcher`   | Part of the game's name, case-insensitive.                                                                                                                                                                                                                                    |
