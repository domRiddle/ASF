...
- **[Microsoft Visual C++ Redistributable Update](https://docs.microsoft.com/cpp/windows/latest-supported-vc-redist?view=msvc-170#visual-studio-2015-2017-2019-and-2022)** (**[x64](https://aka.ms/vs/16/release/vc_redist.x64.exe)** для 64-розрядної Windows, **[x86](https://aka.ms/vs/16/release/vc_redist.x86.exe)** для 32-розрядної Windows)
...
- Якщо ви користуєтесь Windows 7, ви будете змушені запустити **[універсальний](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Setting-up#generic-setup)** різновид ASF, бо ваша ОС більше не підтримується пакетом для конкретної ОС. Ми наполегливо радимо вам скоріше оновитися, бо майбутні версії ASF можуть взагалі припинити працювати з цією ОС, не кажучи вже про те що ця ОС досягла кінця підтримки ще у 2020 році.
...
Після завантаження, почніть з того щоб розпакувати файл zip до окремої папки. Ми радимо користуватися **[7-zip](https://www.7-zip.org)**, але усі стандартні утиліти на зразок `unzip` зі складу Linux/macOS мають також працювати без проблем.
