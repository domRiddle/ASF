...
**Порада:** Якщо ви не хочете змінювати жоден з цих параметрів, ви можете просто залишити для них усіх значення за замовчуванням, тому ви можете просто закрити `ASF.json` та перейти до конфігурації ботів.
