...
Якщо ви шукаєте чорний список для окремих ботів, зверніть увагу на **[команди](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Commands-uk-UA)** `ib`, `ibadd` та `ibrm`.
