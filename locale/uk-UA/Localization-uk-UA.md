...
На сторінках wiki ви також зустрінете локальні посилання, які вказують на окремий розділ документу. Ці посилання починаються з символу `#`.
