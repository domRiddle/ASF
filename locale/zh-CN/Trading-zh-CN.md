...
- 如果交易倾向于增加您的卡牌套组收集进度，则视为**有利**。 Example: A A (before) -> A B (after)
- 如果交易不会影响您的卡牌套组收集进度，则视为**平衡**。 Example: A B (before) -> A C (after)
- 如果交易倾向于减少您的卡牌套组收集进度，则视为**不利**。 Example: A C (before) -> A A (after)
