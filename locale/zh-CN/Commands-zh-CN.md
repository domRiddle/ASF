...
| `mab [Bots]`                                                         | `Master`        | 列出 **[`MatchActively`](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Trading-zh-CN#matchactively)** 自动交易的 App 黑名单。                       |
| `mabadd [Bots] <AppIDs>`                                       | `Master`        | 将给定的 `AppIDs` 加入到 **[`MatchActively`](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Trading-zh-CN#matchactively)** 自动交易的 App 黑名单。        |
