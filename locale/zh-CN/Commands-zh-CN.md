...
| `2fafinalize [Bots] <ActivationCode>`                          | `Master`        | 完成为指定机器人绑定新[**验证器**](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication-zh-CN#创建)的流程。                                               |
| `2fainit [Bots]`                                                     | `Master`        | 开始为指定机器人绑定新[**验证器**](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication-zh-CN#创建)的流程。                                               |
