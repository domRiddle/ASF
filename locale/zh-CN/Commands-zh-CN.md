...
自 V4.0.0.9 版本开始，ASF 支持交互式控制台，只要您没有让它在 [**`Headless`**](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Configuration-zh-CN#headless) 模式下运行。 只需要按下 `c` 键就可以启用命令模式，此时您可以输入命令，并按回车键确认。
...
| `2fafinalize [Bots] <ActivationCode>`                          | `Master`        | 完成为指定机器人绑定新[**两步验证**](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication-zh-CN#创建)凭据的流程。                                            |
| `2fafinalized [Bots] <ActivationCode>`                         | `Master`        | 为指定机器人导入已创建完成的[**两步验证**](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication-zh-CN#创建)凭据，并用代码验证。                                     |
| `2fafinalizedforce [Bots]`                                           | `Master`        | 为指定机器人导入已创建完成的[**两步验证**](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication-zh-CN#创建)凭据，并跳过代码验证。                                    |
...
| `points [Bots]`                                                      | `Master`        | 显示指定机器人的 [**Steam 商店**](https://store.steampowered.com/points/shop)点数余额。                                                                                       |
