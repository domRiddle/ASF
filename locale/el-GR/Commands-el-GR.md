...
| `κάνε παύση [Bots]`                                                  | `Operator`      | Permanently pauses automatic cards farming module of given bot instances. ASF will not attempt to farm current account in this session, unless you manually `resume` it, or restart the process.                                                                                                                                    |
...
| `επανεκκίνηση`                                                       | `Owner`         | Restarts ASF process.                                                                                                                                                                                                                                                                                                               |
...
| `σταμάτησε [Bots]`                                                   | `Master`        | Stops given bot instances.                                                                                                                                                                                                                                                                                                          |
...
| `ενημέρωση`                                                          | `Owner`         | Checks GitHub for ASF updates (this is done automatically every `UpdatePeriod`).                                                                                                                                                                                                                                                    |
...
| `όνομα` | `n`   | `name/Witcher`   | Part of the game's name, case-insensitive.                                                                                                                                                                                                                              |
