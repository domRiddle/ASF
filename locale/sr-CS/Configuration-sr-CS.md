...
Ova stranica namijenjena je ASF konfiguraciji. Služi kao kompletna dokumentacija `config` direktorijuma, što vam omogućava da podesite ASF shodno vašim potrebama.

* **[Uvod](#introduction)**
* **[Online ConfigGenerator](#web-based-configgenerator)**
* **[ASF-ui configuration](#asf-ui-configuration)**
* **[Ručna konfiguracija](#manual-configuration)**
* **[Globalna konfiguracija](#global-config)**
* **[Konfiguracija botova](#bot-config)**
* **[Struktura fajlova](#file-structure)**
* **[JSON izgled](#json-mapping)**
* **[Kompatablini izgled](#compatibility-mapping)**
* **[Kompatabilnost konfiguracija](#configs-compatibility)**
...
Globalna konfiguracija se nalazi u `ASF.json` fajlu i sadrži sledeću strukturu:
