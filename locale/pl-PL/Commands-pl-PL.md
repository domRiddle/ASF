...
| `wstrzymaj [Bots]`                                                   | `Operator`      | Permanently pauses automatic cards farming module of given bot instances. ASF will not attempt to farm current account in this session, unless you manually `resume` it, or restart the process.                                                                                                                                                                |
...
| `wznów [Bots]`                                                       | `FamilySharing` | Resumes automatic farming of given bot instances. Also see `pause`, `play`.                                                                                                                                                                                                                                                                                     |
| `uruchom [Bots]`                                                     | `Master`        | Rozpoczyna się biorąc pod uwagę bot wystąpień.                                                                                                                                                                                                                                                                                                                  |
...
| `zatrzymaj [Bots]`                                                   | `Master`        | Przystanki, biorąc pod uwagę bot wystąpień.                                                                                                                                                                                                                                                                                                                     |
