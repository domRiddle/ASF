...
ASF會盡量減少與其他ASF實例的作業系統層面的跨程序通訊。 這包含ASF針對其他實例檢查它們的組態設定資料夾，及共用&#8203;`*LimiterDelay`&#8203;**[全域設定屬性](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Configuration-zh-TW#global-config)**&#8203;，確保執行多個ASF實例不會造成速率限制問題。 在技術方面，所有平台皆使用我們專屬的ASF自訂機制，在臨時資料夾中建立基於檔案的鎖，在Windows上為&#8203;`C:\Users\<YourUser>\AppData\Local\Temp\ASF`&#8203;，而在Unix上為&#8203;`/tmp/ASF`&#8203;。
