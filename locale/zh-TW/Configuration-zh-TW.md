...
簡而言之，在大多數情形下預設值是適合的，但如果需要，您可能會想要增加它。 不過遠高於預設值也沒有任何意義，因為更多的逾時時間也無法神奇地修復無法存取的Steam伺服器。 除非您有理由編輯此屬性，否則您應將它維持為預設值。
