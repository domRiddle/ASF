...
要找到您的權杖，須以&#8203;`Master`&#8203;權限的使用者登入，並前往&#8203;**[這裡](https://steamcommunity.com/my/tradeoffers/privacy)**&#8203;，然後查看您的交易URL。 要找到您的權杖，須以&#8203;`Master`&#8203;權限的使用者登入，並前往&#8203;**[這裡](https://steamcommunity.com/my/tradeoffers/privacy)**&#8203;，然後查看您的交易URL。 您應該複製這8個字元並於此處貼上，作為&#8203;`SteamTradeToken`&#8203;。 請不要包含整個交易URL，也不需&#8203;`&token=`&#8203;部分，只需要權杖就好（8個字元）。
