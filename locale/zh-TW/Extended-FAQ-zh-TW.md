...
作為我們在GitHub上發布的一部分，我們使用與&#8203;**[Debian](https://www.debian.org/CD/verify)**&#8203;非常相似的驗證過程。 In every official release, in addition to `zip` build assets, you can find `SHA512SUMS` and `SHA512SUMS.sign` files. 將它們與您所選的&#8203;`zip`&#8203;檔案一起下載，用於驗證。
