...
您PC的安全也是一樣。 是的，您PC上的惡意程式會從每個地方破壞ASF的安全性，因為它可以從ASF設定檔或程序的記憶體中讀取敏感資訊，甚至影響程式，執行它本不會執行的操作。 不，您從可疑來源取得的最新破解程式並不像某些人告訴您的那樣是個「誤報」，它是控制其他人PC的最有效方法之一，被入侵的這傢伙會感染自己，甚至還會依照指示進行操作，真有趣。
