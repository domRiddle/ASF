...
| `2fafinalized [Bots] <ActivationCode>`                         | `Master`        | 為指定Bot實例匯入已最終化的&#8203;**[雙重驗證](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication-zh-TW#建立)**&#8203;憑證，並使用代碼驗證。                                                                                           |
| `2fafinalizedforce [Bots]`                                           | `Master`        | 為指定Bot實例匯入已最終化的&#8203;**[雙重驗證](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication-zh-TW#建立)**&#8203;憑證，並跳過代碼驗證。                                                                                           |
