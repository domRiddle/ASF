...
| `input [Bots] <Type> <Value>`                            | `Master`        | 為指定Bot實例輸入指定類型的輸入值，僅在&#8203;`Headless`&#8203;模式下運作──請參閱&#8203;**[下文](#input-指令)**&#8203;的說明。                                                                                                                                         |
...
| `points [Bots]`                                                      | `Master`        | 顯示指定Bot實例的&#8203;**[Steam 商店](https://store.steampowered.com/points/shop)**&#8203;點數餘額。                                                                                                                                              |
