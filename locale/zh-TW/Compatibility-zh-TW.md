...
- `win-x64` 支援 64 位 Windows 作業系統。 This includes Windows 7 (SP1+), 10, 11, Server 2012+ as well as future versions.
...
- `osx-x64` 支援64 位 OS X 作業系統。 This includes version 10.14, as well as future ones.
