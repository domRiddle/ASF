...
- `win-x64` WERKZ ON 64-BIT WINDOWS OSEZ. This includes Windows 7 (SP1+), 10, 11, Server 2012+ as well as future versions.
...
- `osx-x64` WERKZ ON 64-BIT OS X OSEZ. This includes version 10.14, as well as future ones.
