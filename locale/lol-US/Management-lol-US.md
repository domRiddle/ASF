...
ASF doesn't forcefully stop you from doing so, only displays a warning with a short notice. JUS DOAN BE SHOCKD IF WAN DAI DUE 2 BUG IN DA PROGRAM ITLL BLOW UP UR WHOLE OS WIF COMPLETE DATA LOS - UVE BEEN WARND.
