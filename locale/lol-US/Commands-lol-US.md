...
| `2fafinalize [Bots] <ActivationCode>`                          | `Master`        | FINALIZEZ PROCES OV ASSIGNIN NEW **[2FA](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication-lol-US#creashun)** CREDENTIALS 4 GIVEN BOT INSTANCEZ.                                                                                                                                  |
| `2fafinalized [Bots] <ActivationCode>`                         | `Master`        | IMPORTS ALREADY-FINALIZD **[2FA](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication-lol-US#creashun)** CREDENTIALS 4 GIVEN BOT INSTANCEZ, USIN CODE 4 VERIFICASHUN.                                                                                                                |
| `2fafinalizedforce [Bots]`                                           | `Master`        | IMPORTS ALREADY-FINALIZD **[2FA](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication-lol-US#creashun)** CREDENTIALS 4 GIVEN BOT INSTANCEZ, SKIPPIN CODE VERIFICASHUN.                                                                                                               |
