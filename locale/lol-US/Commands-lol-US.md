...
| `2fafinalize [Bots] <ActivationCode>`                          | `Master`        | FINALIZEZ PROCES OV ASSIGNIN NEW **[2FA](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication-lol-US#creashun)** CREDENTIALS 4 GIVEN BOT INSTANCEZ, USIN SMS ACTIVASHUN CODE.                                                                                                        |
