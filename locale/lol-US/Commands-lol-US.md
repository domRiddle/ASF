...
- THRU R **[IPC](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/IPC)** INTERFACE
...
`input MySteamGuardBot SteamGuard ABCDE` -> WE SET `SteamGuard` INPUT OV `MySteamGuardBot` BOT 2 `C`. OV COURSE, `ABCDE` IN DIS CASE IZ AUTH CODE DAT WE GOT ON R E-MAIL.
