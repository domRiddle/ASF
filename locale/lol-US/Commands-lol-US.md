...
STARTIN WIF V4.0.0.9, ASF HAS SUPPORT 4 INTERACTIV CONSOLE DAT CAN BE ENABLD BY SETTIN UP [**`SteamOwnerID`**](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Configuration-lol-US#steamownerid) PROPERTY. AFTERWARDZ, SIMPLY PRES `c` BUTN IN ORDR 2 ENABLE COMMAND MODE, TYPE UR COMMAND AN CONFIRM WIF ENTR.

![Screenshot](https://i.imgur.com/bH5Gtjq.png)

INTERACTIV CONSOLE IZ NOT AVAILABLE IN [**`Headless`**](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Configuration-lol-US#headless) MODE.
...
| `bladd [Bots] <SteamIDs64>`                                    | `Master`        | BLACKLISTS GIVEN `steamIDs` FRUM TRADIN MODULE OV GIVEN BOT INSTANCEZ.                                                                                                                                                                                                                                        |
| `blrm [Bots] <SteamIDs64>`                                     | `Master`        | REMOVEZ BLACKLIST OV GIVEN `steamIDs` FRUM TRADIN MODULE OV GIVEN BOT INSTANCEZ.                                                                                                                                                                                                                              |
...
| `ib [Bots]`                                                          | `Master`        | LISTS APPS BLACKLISTD FRUM AUTOMATIC IDLIN OV GIVEN BOT INSTANCEZ.                                                                                                                                                                                                                                            |
| `ibadd [Bots] <AppIDs>`                                        | `Master`        | ADDZ GIVEN `appIDs` 2 APPS BLACKLISTD FRUM AUTOMATIC IDLIN OV GIVEN BOT INSTANCEZ.                                                                                                                                                                                                                            |
| `ibrm [Bots] <AppIDs>`                                         | `Master`        | REMOVEZ GIVEN `appIDs` FRUM APPS BLACKLISTD FRUM AUTOMATIC IDLIN OV GIVEN BOT INSTANCEZ.                                                                                                                                                                                                                      |
| `iq [Bots]`                                                          | `Master`        | LISTS PRIORITY IDLIN KEW OV GIVEN BOT INSTANCEZ.                                                                                                                                                                                                                                                              |
| `iqadd [Bots] <AppIDs>`                                        | `Master`        | ADDZ GIVEN `appIDs` 2 PRIORITY IDLIN KEW OV GIVEN BOT INSTANCEZ.                                                                                                                                                                                                                                              |
| `iqrm [Bots] <AppIDs>`                                         | `Master`        | REMOVEZ GIVEN `appIDs` FRUM PRIORITY IDLIN KEW OV GIVEN BOT INSTANCEZ.                                                                                                                                                                                                                                        |
...
| `mab [Bots]`                                                         | `Master`        | LISTS APPS BLACKLISTD FRUM AUTOMATIC TRADIN IN **[`MatchActively`](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Trading-lol-US#matchactively)**.                                                                                                                                                       |
| `mabadd [Bots] <AppIDs>`                                       | `Master`        | ADDZ GIVEN `appIDs` 2 APPS BLACKLISTD FRUM AUTOMATIC TRADIN IN **[`MatchActively`](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Trading-lol-US#matchactively)**.                                                                                                                                       |
| `mabrm [Bots] <AppIDs>`                                        | `Master`        | REMOVEZ GIVEN `appIDs` FRUM APPS BLACKLISTD FRUM AUTOMATIC TRADIN IN **[`MatchActively`](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Trading-lol-US#matchactively)**.                                                                                                                                 |
...
| `password [Bots]`                                                    | `Master`        | PRINTS ENCRYPTD PASWORD OV GIVEN BOT INSTANCEZ (IN USE WIF `PasswordFormat`).                                                                                                                                                                                                                                 |
...
| `reset [Bots]`                                                       | `Master`        | RESETS TEH PLAYIN STATUS BAK 2 NORMAL, USD DURIN MANUAL FARMIN WIF `play` COMMAND.                                                                                                                                                                                                                            |
| `restart`                                                            | `Owner`         | RESTARTS ASF PROCES.                                                                                                                                                                                                                                                                                          |
| `resume [Bots]`                                                      | `FamilySharing` | RESUMEZ AUTOMATIC FARMIN OV GIVEN BOT INSTANCEZ. ALSO C `pause`, `play`.                                                                                                                                                                                                                                      |
...
| `update`                                                             | `Owner`         | CHECKZ GITHUB 4 ASF UPDATEZ (DIS AR TEH DUN AUTOMATICALLY EVRY `UpdatePeriod`).                                                                                                                                                                                                                               |
...
LETS SAY DAT WE HAS BOT DAT IZ PROTECTD BY STEAMGUARD IN NON-2FA MODE. We want to launch that bot with `Headless` set to `true`.
