...
TYPICALLY ULL WANTS 2 USE **[ASF 2FA](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication-lol-US)** TOGETHR WIF DIS FEACHUR, ALTHOUGH IZ NOT REQUIREMENT IF U INTEND 2 HANDLE 2FA CONFIRMASHUNS MANUALLY IN TIEMLY FASHION. IF URE NOT SURE HOW 2 SET DIS PROPERTY, LEEF IT WIF DEFAULT VALUE OV `false`.
