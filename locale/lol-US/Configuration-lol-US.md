...
IN ORDR 2 USE ASF-UI, U MUST HAS R **[IPC](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/IPC-lol-US)** INTERFACE ENABLD ITSELF. `IPC` is enabled by default, therefore you can access it right away, as long as you didn't disable it yourself.
