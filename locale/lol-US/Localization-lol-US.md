...
- MISTAEK IN DA SOURCE STRIN - DIS SHUD BE USD ONLY IF U BLEEV DAT ORIGINAL (ENGLISH) STRIN IZ INCORRECT. Quite rare, but not all of us are speaking English natively either, so feel free to use it if you have a general idea how it could be improved. ALTERNATIVELY, SINCE DIS AR TEH STRICTLY RELATD 2 TEH DEVELOPMENT, U CUD USE R **[GITHUB ISSUEZ](https://github.com/JustArchiNET/ArchiSteamFarm/issues/new/choose)** 4 DAT PURPOSE, IF UD LIEK 2.
