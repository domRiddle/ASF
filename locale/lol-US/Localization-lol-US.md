...
4 EXAMPLE, ASF **[HOME PAEG](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Home)** INCLUDEZ TEXT SUCH AS:

> IF URE NEW USR, WE RECOMMEND STARTIN WIF **[SETTIN UP](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Setting-up)** GUIDE.

WHICH IZ ORIGINALLY WRITTEN AS:

```markdown
IF URE NEW USR, WE RECOMMEND STARTIN WIF **[SETTIN UP](HTTPS://GITHUB.COM/JUSTARCHINET/ARCHISTEAMFARM/WIKI/SETTIN-UP)** GUIDE.
```
...
4 EXAMPLE U CAN FIND `#INTRODUCSHUN` LINK IN R **[CONFIGURASHUN](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Configuration-lol-US#introducshun)** SECSHUN:
