...
- **U CANT DROP CARDZ FRUM F2P GAMEZ WITHOUT SPENDIN ANY MONEY IN THEM. This means permanently F2P games like Team Fortress 2 or Dota 2. Owning F2P games does not grant you card drops.**
...
OV COURSE, ALL OV DAT ASSUMEZ DAT URE RUNNIN ASF WIF DEFAULT UNTOUCHD SETTINGS, SINCE U CUD ALSO ADD DIS GAME 2 IDLIN BLACKLIST, USE `IdlePriorityQueueOnly` OV `true`, USE `IdleRefundableGames` OV `false` AN SO ON.
