...
ASF IZ AVAILABLE AS **[DOCKR CONTAINR](https://www.docker.com/what-container)**. R DOCKR PACKAGEZ R CURRENTLY AVAILABLE ON **[ghcr.io](https://github.com/orgs/JustArchiNET/packages/container/archisteamfarm/versions)** AS WELL AS **[DOCKR HUB](https://hub.docker.com/r/justarchi/archisteamfarm)**.
