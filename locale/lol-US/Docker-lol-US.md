...
DIS HAS 2 BE DUN ONLY ONCE AFTR U CREATD UR CONTAINR WIF `DOCKR RUN`, AN ONLY IF U DECIDD 2 USE CUSTOM USR 4 ASF PROCES. ALSO DOAN FORGET 2 CHANGE `1000:1000` ARGUMENT IN BOTH COMMANDZ ABOOV 2 TEH `uid` AN `gid` U AKSHULLY WANTS 2 RUN ASF UNDR.
