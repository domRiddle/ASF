...
![Kuvakaappaus](https://raw.githubusercontent.com/JustArchiNET/ASF-ui/master/.github/previews/commands.png)

* * *

## Komennot

| Command                                                              | Pääsy           | Description                                                                                                                                                                                                                                                                                                                         |
| -------------------------------------------------------------------- | --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| `poistu`                                                             | `Owner`         | Stops whole ASF process.                                                                                                                                                                                                                                                                                                            |
...
| `keskeytä [Bots]`                                                    | `Operator`      | Permanently pauses automatic cards farming module of given bot instances. ASF will not attempt to farm current account in this session, unless you manually `resume` it, or restart the process.                                                                                                                                    |
...
| `käynnistä uudelleen`                                                | `Owner`         | Restarts ASF process.                                                                                                                                                                                                                                                                                                               |
| `jatka [Bots]`                                                       | `FamilySharing` | Resumes automatic farming of given bot instances. Also see `pause`, `play`.                                                                                                                                                                                                                                                         |
| `käynnistä [Bots]`                                                   | `Master`        | Starts given bot instances.                                                                                                                                                                                                                                                                                                         |
...
| `pysäytä [Bots]`                                                     | `Master`        | Stops given bot instances.                                                                                                                                                                                                                                                                                                          |
...
| `päivitä`                                                            | `Owner`         | Checks GitHub for ASF updates (this is done automatically every `UpdatePeriod`).                                                                                                                                                                                                                                                    |
| `versio`                                                             | `FamilySharing` | Prints version of ASF.                                                                                                                                                                                                                                                                                                              |
...
| Type  | Alias | Esimerkki    | Description                                                             |
| ----- | ----- | ------------ | ----------------------------------------------------------------------- |
...
| `nimi`  | `n`   | `name/Witcher`   | Part of the game's name, case-insensitive.                                                                                                                                                                                                                              |
...
| Salasana                | `SteamPassword` bot config property, if missing from config.               |
