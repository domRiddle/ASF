...
| `sair`                                                               | `Owner`         | Stops whole ASF process.                                                                                                                                                                                                                                                                                                            |
...
| `pausar [Bots]`                                                      | `Operator`      | Permanently pauses automatic cards farming module of given bot instances. ASF will not attempt to farm current account in this session, unless you manually `resume` it, or restart the process.                                                                                                                                    |
...
| `retomar [Bots]`                                                     | `FamilySharing` | Resumes automatic farming of given bot instances. Also see `pause`, `play`.                                                                                                                                                                                                                                                         |
| `iniciar [Bots]`                                                     | `Master`        | Starts given bot instances.                                                                                                                                                                                                                                                                                                         |
...
| `parar [Bots]`                                                       | `Master`        | Stops given bot instances.                                                                                                                                                                                                                                                                                                          |
...
| `atualizar`                                                          | `Owner`         | Checks GitHub for ASF updates (this is done automatically every `UpdatePeriod`).                                                                                                                                                                                                                                                    |
...
| Senha                   | `SteamPassword` bot config property, if missing from config.               |
