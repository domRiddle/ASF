...
Agora navegue mais uma vez até nosso gerador de configuração web e coloque esse número em SteamOwnerID. Por último, você precisa habilitar a opção `IPC` para a interface funcionar.
