...
| `play <Bots> <AppIDs,GameName>`                                | `Master`            | Muda para o modo de coleta manual - abre o jogo indicado pela `AppIds` no bot determinado, opcionalmente pode-se usar um nome customizado `GameName`. Use `reset` ou `resume` para retomar.                                                                      |
