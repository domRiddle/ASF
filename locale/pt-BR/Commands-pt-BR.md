...
| `pausar [Bots]`                                                      | `Operator`          | Para permanentemente o módulo de coleta automática de cartas dos bots indicados. O ASF não tentará coletar nessa conta durante essa sessão, a menos que você retome manualmente por meio do comando `resume` ou reinicie o processo.                                                                                                                                     |
...
| `retomar [Bots]`                                                     | `FamilySharing`     | Retoma a coleta automática nos bots indicados. Veja também `pause`, `play`.                                                                                                                                                                                                                                                                                              |
| `iniciar [Bots]`                                                     | `Master`            | Inicia os bots indicados.                                                                                                                                                                                                                                                                                                                                                |
...
| `parar [Bots]`                                                       | `Master`            | Para os bots indicados.                                                                                                                                                                                                                                                                                                                                                  |
