...
* Uma linha única para ser traduzida com o link incluso em `Hidden texts` -> `Link addresses` (raros, ocorre onde a linha toda é um link, mais comum na barra lateral)
