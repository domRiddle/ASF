...
Tipo `ImmutableList<byte>` com o valor padrão vazio. This property defines the **preferred** farming order used by ASF for given bot account. Atualmente existem as seguintes ordens disponíveis:
