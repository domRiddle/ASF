...
Tipo `byte flags` com o valor padrão `0`. Essa propriedade define o comportamento do ASF quando estiver resgatando códigos de produto, e é explicada abaixo:
