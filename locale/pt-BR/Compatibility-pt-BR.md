...
- `linux-x64` compatível com a versão de 64 bits do GNU/Linux. Isso inclui Alpine, CentOS/Fedora/RHEL, Debian/Ubuntu, OpenSUSE/SLES e muitos outros, incluindo seus derivados, nas versões atuais e futuras.
...
- `osx-x64` funciona em Sistemas Operacionais OS X 64-bit. Isso inclui a versão 10.15, bem como futuras versões.
