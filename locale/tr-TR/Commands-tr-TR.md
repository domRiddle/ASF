...
![Ekran Görüntüsü](https://raw.githubusercontent.com/JustArchiNET/ASF-ui/master/.github/previews/commands.png)
...
| -------------------------------------------------------------------------- | ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `2fa <Bots>`                                                         | `Usta`           | Generates temporary **[2FA](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication)** token for given bot instances.                                                                                            |
| `2fano <Bots>`                                                       | `Usta`           | Denies all pending **[2FA](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication)** confirmations for given bot instances.                                                                                     |
...
| `addlicense <Bots> <Licenses>`                                 | `Operatör`       | Activates given `licenses`, explained **[below](#addlicense-licenses)**, on given bot instances (free games only).                                                                                                                     |
...
| `yardım`                                                                   | `Aile Paylaşımı` | Shows help (link to this page).                                                                                                                                                                                                        |
...
| `ibrm <Bots> <AppIDs>`                                         | `Usta`           | Removes given `appIDs` from apps blacklisted from automatic idling of given bot instances.                                                                                                                                             |
| `iq <Bots>`                                                          | `Usta`           | Lists priority idling queue of given bot instances.                                                                                                                                                                                    |
| `iqadd <Bots> <AppIDs>`                                        | `Usta`           | Adds given `appIDs` to priority idling queue of given bot instances.                                                                                                                                                                   |
| `iqrm <Bots> <AppIDs>`                                         | `Usta`           | Removes given `appIDs` from priority idling queue of given bot instances.                                                                                                                                                              |
| `level <Bots>`                                                       | `Usta`           | Shows Steam account level of given bot instances.                                                                                                                                                                                      |
| `loot <Bots>`                                                        | `Usta`           | Sends all `LootableTypes` Steam community items of given bot instances to `Master` user defined in their `SteamUserPermissions` (with lowest steamID if more than one).                                                                |
| `loot@ <Bots> <RealAppIDs>`                                    | `Usta`           | Sends all `LootableTypes` Steam community items matching given `RealAppIDs` of given bot instances to `Master` user defined in their `SteamUserPermissions` (with lowest steamID if more than one). This is the opposite of `loot%`.   |
| `loot% <Bots> <RealAppIDs>`                                    | `Usta`           | Sends all `LootableTypes` Steam community items apart from given `RealAppIDs` of given bot instances to `Master` user defined in their `SteamUserPermissions` (with lowest steamID if more than one). This is the opposite of `loot@`. |
| `loot^ <Bots> <AppID> <ContextID>`                       | `Usta`           | Sends all Steam items from given `AppID` in `ContextID` of given bot instances to `Master` user defined in their `SteamUserPermissions` (with lowest steamID if more than one).                                                        |
| `kullanıcı adı <Bots> <Nickname>`                              | `Usta`           | Changes Steam nickname of given bot instances to given `nickname`.                                                                                                                                                                     |
| `owns <Bots> <Games>`                                          | `Operatör`       | Checks if given bot instances already own given `games`, explained **[below](#owns-games)**.                                                                                                                                           |
| `şifre <Bots>`                                                       | `Usta`           | Prints encrypted password of given bot instances (in use with `PasswordFormat`).                                                                                                                                                       |
| `duraklat <Bots>`                                                    | `Operatör`       | Permanently pauses automatic cards farming module of given bot instances. ASF will not attempt to farm current account in this session, unless you manually `resume` it, or restart the process.                                       |
| `duraklat~ <Bots>`                                                   | `Aile Paylaşımı` | Temporarily pauses automatic cards farming module of given bot instances. Farming will be automatically resumed on the next playing event, or bot disconnect. You can `resume` farming to unpause it.                                  |
...
| `play <Bots> <AppIDs,GameName>`                                | `Usta`           | Switches to manual farming - launches given `AppIDs` on given bot instances, optionally also with custom `GameName`. Use `reset` or `resume` for returning.                                                                            |
| `privacy <Bots> <Settings>`                                    | `Usta`           | Changes **[Steam privacy settings](https://steamcommunity.com/my/edit/settings)** of given bot instances, to appropriately selected options explained **[below](#privacy-settings)**.                                                  |
...
| `reset <Bots>`                                                       | `Usta`           | Resets the playing status back to normal, used during manual farming with `play` command.                                                                                                                                              |
| `yeniden başlat`                                                           | `Owner`          | Restarts ASF process.                                                                                                                                                                                                                  |
| `resume <Bots>`                                                      | `Aile Paylaşımı` | Resumes automatic farming of given bot instances. Also see `pause`, `play`.                                                                                                                                                            |
| `start <Bots>`                                                       | `Usta`           | Starts given bot instances.                                                                                                                                                                                                            |
| `stats`                                                                    | `Owner`          | Prints process statistics, such as managed memory usage.                                                                                                                                                                               |
| `status <Bots>`                                                      | `Aile Paylaşımı` | Prints status of given bot instances.                                                                                                                                                                                                  |
| `stop <Bots>`                                                        | `Usta`           | Stops given bot instances.                                                                                                                                                                                                             |
| `transfer <Bots> <TargetBot>`                                  | `Usta`           | Sends all `TransferableTypes` Steam community items from given bot instances to target bot instance.                                                                                                                                   |
| `transfer@ <Bots> <RealAppIDs> <TargetBot>`              | `Usta`           | Sends all `TransferableTypes` Steam community items matching given `RealAppIDs` from given bot instances to target bot instance. This is the opposite of `transfer%`.                                                                  |
| `transfer% <Bots> <RealAppIDs> <TargetBot>`              | `Usta`           | Sends all `TransferableTypes` Steam community items apart from given `RealAppIDs` from given bot instances to target bot instance. This is the opposite of `transfer@`.                                                                |
| `transfer^ <Bots> <AppID> <ContextID> <TargetBot>` | `Usta`           | Sends all Steam items from given `AppID` in `ContextID` of given bot instances to target bot instance.                                                                                                                                 |
| `unpack <Bots>`                                                      | `Usta`           | Unpacks all booster packs stored in the inventory of given bot instances.                                                                                                                                                              |
| `güncelle`                                                                 | `Owner`          | Checks GitHub for ASF updates (this is done automatically every `UpdatePeriod`).                                                                                                                                                       |
| `version`                                                                  | `Aile Paylaşımı` | Prints version of ASF.                                                                                                                                                                                                                 |
...
| `isim`  | `n`   | `name/Witcher`   | Part of the game's name, case-insensitive.                                                                                                                                                                                                                                    |
