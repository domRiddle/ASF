...
| `nickname [Bots] <Nickname>`                                   | `Usta`           | Changes Steam nickname of given bot instances to given `nickname`.                                                                                                                                                                                                                                                                  |
| `owns [Bots] <Games>`                                          | `Operatör`       | Checks if given bot instances already own given `games`, explained **[below](#owns-games)**.                                                                                                                                                                                                                                        |
| `password [Bots]`                                                    | `Usta`           | Prints encrypted password of given bot instances (in use with `PasswordFormat`).                                                                                                                                                                                                                                                    |
| `[Bots] duraklat`                                                    | `Operatör`       | Permanently pauses automatic cards farming module of given bot instances. ASF will not attempt to farm current account in this session, unless you manually `resume` it, or restart the process.                                                                                                                                    |
...
| `[Bots] sürdür`                                                      | `Aile Paylaşımı` | Resumes automatic farming of given bot instances. Also see `pause`, `play`.                                                                                                                                                                                                                                                         |
| `[Bots] başlat`                                                      | `Usta`           | Starts given bot instances.                                                                                                                                                                                                                                                                                                         |
...
| `[Bots] durdur`                                                      | `Usta`           | Stops given bot instances.                                                                                                                                                                                                                                                                                                          |
