...
| `owns <Bots> <AppIDsOrGameNames>`                              | `Operatör`      | Checks if given bot instances already own given `appIDs` and/or `gameNames` (can be part of the game's name). It can also be `*` to show all games available.                                         |
...
| `play <Bots> <AppIDs,GameName>`                                | `Usta`          | Switches to manual farming - launches given `AppIDs` on given bot instances, optionally also with custom `GameName`. Use `resume` for returning to automatic farming.                                 |
...
| `rejoinchat <Bots>`                                                  | `Operatör`      | Forces given bot instances to rejoin their `SteamMasterClanID` group chat.                                                                                                                            |
...
| `transfer <Bots> <TargetBot>`                                  | `Usta`          | Sends all `TransferableTypes` Steam community items from given bot instances to target bot.                                                                                                           |
| `transfer@ <Bots> <RealAppIDs> <TargetBot>`              | `Usta`          | Sends all `TransferableTypes` Steam community items matching given `RealAppIDs` from given bot instances to target bot.                                                                               |
| `transfer^ <Bots> <AppID> <ContextID> <TargetBot>` | `Usta`          | Sends all Steam items from given `AppID` in `ContextID` of given bot instances to target bot.                                                                                                         |
