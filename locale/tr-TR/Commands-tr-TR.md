...
| `2fafinalize [Bots] <ActivationCode>`                          | `Master`         | Her iki örnek için de yeni **[2FA](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication#creation)** kimliklerini atama işlemini tamamlar.                                                                                                                                                                  |
| `2fafinalized [Bots] <ActivationCode>`                         | `Master`         | Doğrulama için kod kullanarak, her iki örnek için de önceden kesinleştirilmiş **[2FA](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication#creation)** kimlik bilgilerini içe aktarır.                                                                                                                     |
| `2fafinalizedforce [Bots]`                                           | `Master`         | Kod doğrulamasını atlayarak, her iki örnek için de önceden kesinleştirilmiş **[2FA](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Two-factor-authentication#creation)** kimlik bilgilerini içe aktarır.                                                                                                                       |
