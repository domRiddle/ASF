...
V4.0.0.9'dan itibaren ASF, [**`SteamOwnerID`**](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Configuration#steamownerid) özelliği ayarlanarak etkinleştirilebilen etkileşimli konsol desteğine sahiptir. Daha sonra komut modunu etkinleştirmek için `c` tuşuna basın, komutunuzu yazın ve enter ile onaylayın.
...
| `bl [Bots]`                                                          | `Master`         | Belirli bot örneklerinin ticaret modülünden kara listeye alınmış kullanıcıları listeler.                                                                                                                                                                                                                                            |
| `bladd [Bots] <SteamIDs64>`                                    | `Master`         | Verilen `steamIDs` 'leri takas modülünden verilen bot örnekleri için kara listeye ekler.                                                                                                                                                                                                                                            |
| `blrm [Bots] <SteamIDs64>`                                     | `Master`         | Verilen `steamIDs` 'leri takas modülünden verilen bot örnekleri için kara listeden çıkarır.                                                                                                                                                                                                                                         |
...
| `pause [Bots]`                                                       | `Operatör`       | Permanently pauses automatic cards farming module of given bot instances. ASF will not attempt to farm current account in this session, unless you manually `resume` it, or restart the process.                                                                                                                                    |
...
| `update`                                                             | `Sahip`          | Checks GitHub for ASF updates (this is done automatically every `UpdatePeriod`).                                                                                                                                                                                                                                                    |
