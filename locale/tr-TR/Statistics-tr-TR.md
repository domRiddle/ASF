...
1. Account being used in ASF will join our **[Steam group](https://steamcommunity.com/gid/103582791440160998)** upon login. Bu üç sebepten dolayı yapılır:
...
* ASF'nşn gerçekte kaç adet Steam hesabı tarafından kullanıldığını görmemize olanak tanır
...
* Takma adınız (görüntüleme amaçlı, herkese açık bilgiler)
* Profil resminiz (karma, görüntüleme amaçlı, herkese açık bilgiler)
