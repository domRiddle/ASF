...
- `win-x64` 支援 64 位 Windows 操作系統。 This includes Windows 7 (SP1+), 10, 11, Server 2012+ as well as future versions.
...
- `osx-x64` 適用於64位 OS X 操作系統。 This includes version 10.14, as well as future ones.
