...
In even more rare case when you can't even use `dotnet` command (e.g. because of missing .NET Core SDK and building with `mono`), you can call `msbuild` directly:
