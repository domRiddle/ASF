...
## This page applies only to ASF V3. If you're using ASF V2, please visit **[ASF V2](https://github.com/JustArchi/ArchiSteamFarm/wiki/_Configuration-(ASF-V2))** configuration page instead.
