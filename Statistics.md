...
* Your Steam identificator (in 64-bit form, for generating STM link)
...
* Value specifying if you've enabled ```MatchEverything``` in your ```TradingPreferences``` (for display purpose - sorting)
