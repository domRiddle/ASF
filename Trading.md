...
ASF includes support for Steam non-interactive (offline) trades. Receiving trades as well as responding to them (accepting/rejecting) requires valid ```SteamApiKey``` set for given bot instance. Sending trades doesn't have any special requirements.
