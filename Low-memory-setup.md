...
- Start from simple ASF setup tricks, use generic ASF variant and check if perhaps you're just using your ASF in a wrong way such as starting the process several times for all of your bots, or keeping all of them active if you need just one or two to autostart.
