...
ASF docker image is currently available for `linux` platform on 3 architectures - `amd64`, `arm` and `arm64`. You can read more about them in **[compatibility](https://github.com/JustArchiNET/ArchiSteamFarm/wiki/Compatibility)** section.
