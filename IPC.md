...
This API is dedicated for our IPC GUI usage only and it should not be implemented by remote scripts or tools. This documentation is for our internal reference only and can change at anytime.
