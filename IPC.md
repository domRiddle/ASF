...
- `405 NotAllowed` - the HTTP method you're trying to use is not allowed for this API endpoint. This error is also used for trying to access websocket endpoint without initiating a websocket connection.
